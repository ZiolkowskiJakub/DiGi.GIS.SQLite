...
**DiGi.GIS.SQLite** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.GIS.SQLite](DiGi.GIS.SQLite)** (Path: `DiGi.GIS.SQLite\DiGi.GIS.SQLite`)
